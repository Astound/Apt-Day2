    ...
    <div>
        <li className=' flex justify-between pl-2 mb-4'>
                        <div className='flex'>
                            ...
                            <div className='ml-1'>
                                    <h2 className=' font-semibold text-base'>{props.event}</h2>
                                <p className=' text-gray-400 text-xs'>{props.timestamp}</p>
                            </div>
                        </div>
                        <div>
                        {props.price}
